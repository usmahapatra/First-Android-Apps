...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        youTubePlayerView=(YouTubePlayerView)v.findViewById(R.id.youTubePlayerView);
        YouTubePlay playVid=new YouTubePlay();
        playVid.playVideo(mParam1);
        return v;
    }

     public class youT extends YouTubeBaseActivity
     {
         public Y initialize(){
